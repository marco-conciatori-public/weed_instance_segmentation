...
def load_model():
    ...
    model_id_or_path = 'models/mask2former_finetuned/2026-02-04_20-56-07/best_model'
    # model_id_or_path = 'models/mask2former_finetuned/2026-02-04_20-56-07/final_model'
